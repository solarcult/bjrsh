...
public class PlayerStrategyMatrixTwoOne extends PlayerStrategyMatrix{
	
	public PlayerStrategyMatrixTwoOne(){
	...
	public static void main(String[] args){
		new PlayerStrategyMatrixTwoOne().printStrategyMatrix();
	}
}
